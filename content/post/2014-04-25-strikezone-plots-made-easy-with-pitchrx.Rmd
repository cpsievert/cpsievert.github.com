...
knitr::include_graphics("/post/images/strikeFX-kershaw.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("/post/images/strikeFX-kershaw-density.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("/post/images/strikeFX-kershaw-density2.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("/post/images/strikeFX-kershaw-density3.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("/post/images/strikeFX-kershaw-density4.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("/post/images/strikeFX-kershaw-density5.png")
```
...
For more demonstrations of the capabilities of `strikeFX`, check out the [pitchRx introduction page](http://cpsievert.github.io/pitchRx/) and [the RJournal article](http://cpsievert.github.io/pitchRx/RJwrapper.pdf).
