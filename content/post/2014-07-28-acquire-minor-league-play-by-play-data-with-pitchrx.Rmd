...
knitr::opts_chunk$set(message = FALSE, warning = FALSE, error = FALSE, message = FALSE, fig.align = 'center', eval = FALSE)
```
...
```r
## [1] "gid_2012_02_29_fanbbc_phimlb_1"
```
...
knitr::include_graphics("/post/images/openwar-plot.png")
```
