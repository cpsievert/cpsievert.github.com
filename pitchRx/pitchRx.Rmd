...
strikeFX(pitches, aes(color=des))
```

## Faceting by batter stance

```{r stand, echo=FALSE}
strikeFX(pitches, layer=list(aes(color=des), facet_grid(.~stand)))
```

## Faceting by stance and "home"

```{r home, echo=FALSE}
strikeFX(pitches, layer=list(aes(color=des), facet_grid(top_inning~stand)))
```
