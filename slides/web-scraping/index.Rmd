...
* As statisticians, we typically think of data in a [tidy](http://vita.had.co.nz/papers/tidy-data.pdf) (i.e., tabular) format. That is
    * table rows == observation units
    * table columns == observational attributes
* This is a convenient framework for developing models, but data hardly ever begins in this tidy format.
* This is especially true of data that lives on the web.
* This walk will provide a quick overview of popular methods for acquiring such data using R.
...
* Here we use it to browse through faculty pages.
...
* We use RSelenium to test whether [animint](https://github.com/tdhock/animint) plots are rendered in a browser correctly.
...
<iframe src = "https://gist.github.com/cpsievert/b55ac4a210842da78ed9" width = "1000px" height = "800px"></iframe>
