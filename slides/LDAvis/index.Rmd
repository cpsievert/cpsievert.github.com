...
> - <b>Topic models 'discover <font color="red">to</font><font color="blue">pi</font><font color="green">cs</font>' that occur in a collection of text:</b>
...
$$
\lambda * p(w_i|z_j) + (1 - \lambda) * \text{lift}
$$
...
* For this reason, it is nice to have an _interactive_ tool to _quickly_ explore rankings based different values of $\lambda$.
* The `R` package [LDAvis](https://github.com/cpsievert/LDAvis) makes it easy to create an interactive visualizations to aid topic interpretation using these ideas.

---

[A demo](http://cpsievert.github.io/LDAvis/newsgroup/newsgroup/index.html)

<iframe src = "http://cpsievert.github.io/LDAvis/newsgroup/newsgroup/index.html" width = 1200 height = 800></iframe>
